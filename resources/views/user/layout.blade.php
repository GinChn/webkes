...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-light-red elevation-4">
    <a href="/" class="brand-link" style="background-color: rgba(162, 18, 18, 0.714)">
        <img src="{{ asset('AdminLTE/dist/img/ta bulat.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="/user/data-laporan" class="nav-link {{ ($title === "Data Laporan") ? 'active' : '' }}">
